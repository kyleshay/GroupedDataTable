YAHOO.example.Data = {
    ...
    addresses: [
        {name:"John A. Smith", address:"1236 Some Street", city:"San Francisco", state:"CA", amount:5, active:"yes", colors:["red"], last_login:"4/2/2012"},
        {name:"Joan B. Jones", address:"3271 Another Ave", city:"New York", state:"NY", amount:3, active:"maybe", colors:["blue"], last_login:"6/6/2012"},
        {name:"Bob C. Uncle", address:"9996 Random Road", city:"Los Angeles", state:"CA", amount:2.5, active:"no", colors:["green"], last_login:"1/7/2012"},
        {name:"John D. Smith", address:"1623 Some Street", city:"San Francisco", state:"CA", amount:4, active:"no", colors:["orange"], last_login:"3/4/2012"},
        {name:"Joan E. Jones", address:"3217 Another Ave", city:"New York", state:"NY", amount:7, active:"no", colors:["blue"], last_login:"7/4/2012"},
        {name:"Bob F. Uncle", address:"9899 Random Road", city:"Los Angeles", state:"CA", amount:3, active:"no", colors:["blue"], last_login:"5/8/2012"},
        {name:"John G. Smith", address:"1723 Some Street", city:"San Francisco", state:"CA", amount:1.5, active:"yes", colors:["green"], last_login:"9/7/2012"},
        {name:"Joan H. Jones", address:"3241 Another Ave", city:"New York", state:"NY", amount:2, active:"yes", colors:["black"], last_login:"6/1/2012"},
        {name:"Bob I. Uncle", address:"9909 Random Road", city:"Los Angeles", state:"CA", amount:4.5, active:"maybe", colors:["gray"], last_login:"3/4/2012"},
        {name:"John J. Smith", address:"1623 Some Street", city:"San Francisco", state:"CA", amount:6, active:"maybe", colors:["red"], last_login:"7/3/2012"},
        {name:"Joan K. Jones", address:"3721 Another Ave", city:"New York", state:"NY", amount:3, active:"yes", colors:["orange"], last_login:"2/4/2012"},
        {name:"Bob L. Uncle", address:"9989 Random Road", city:"Los Angeles", state:"CA", amount:1, active:"yes", colors:["orange"], last_login:"8/9/2012"},
        {name:"John M. Smith", address:"1293 Some Street", city:"San Francisco", state:"CA", amount:4, active:"maybe", colors:["green"], last_login:"2/6/2012"},
        {name:"Joan N. Jones", address:"3621 Another Ave", city:"New York", state:"NY", amount:3, active:"no", colors:["red"], last_login:"8/2/2012"},
        {name:"Bob O. Uncle", address:"9959 Random Road", city:"Los Angeles", state:"CA", amount:3, active:"yes", colors:["green"], last_login:"5/8/2012"},
        {name:"John P. Smith", address:"6123 Some Street", city:"San Francisco", state:"CA", amount:6, active:"maybe", colors:["red"], last_login:"9/4/2012"},
        {name:"Joan Q. Jones", address:"3281 Another Ave", city:"New York", state:"NY", amount:3.5, active:"yes", colors:["black"], last_login:"3/8/2012"},
        {name:"Bob R. Uncle", address:"9989 Random Road", city:"Los Angeles", state:"CA", amount:4, active:"no", colors:["green"], last_login:"1/4/2012"}
    ],
